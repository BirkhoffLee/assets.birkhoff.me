...
await Promise.all([
  $`wget -q -O ${windowsFilename} ${windowsUrl} && b2 upload-file --quiet assets-birkhoff-me ./${windowsFilename} clash.exe`,
  $`wget -q -O ${macosFilename} ${macosUrl} && b2 upload-file --quiet assets-birkhoff-me ./${macosFilename} clash.dmg`
])
